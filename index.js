...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
const w=globalThis,_=w.trustedTypes,A=_?_.createPolicy("lit-html",{createHTML:t=>t}):void 0,S="$lit$",k=`lit$${Math.random().toFixed(9).slice(2)}$`,E="?"+k,C=`<${E}>`,P=document,T=()=>P.createComment(""),O=t=>null===t||"object"!=typeof t&&"function"!=typeof t,R=Array.isArray,q="[ \t\n\f\r]",M=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,U=/-->/g,N=/>/g,I=RegExp(`>|${q}(?:([^\\s"'>=/]+)(${q}*=${q}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),z=/'/g,H=/"/g,L=/^(?:script|style|textarea|title)$/i,D=(V=1,(t,...e)=>({_$litType$:V,strings:t,values:e})),j=Symbol.for("lit-noChange"),W=Symbol.for("lit-nothing"),B=new WeakMap,Q=P.createTreeWalker(P,129);var V;function J(t,e){if(!R(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==A?A.createHTML(e):e}class F{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let r=0,a=0;const n=t.length-1,o=this.parts,[l,c]=((t,e)=>{const s=t.length-1,i=[];let r,a=2===e?"<svg>":3===e?"<math>":"",n=M;for(let o=0;o<s;o++){const e=t[o];let s,l,c=-1,d=0;for(;d<e.length&&(n.lastIndex=d,l=n.exec(e),null!==l);)d=n.lastIndex,n===M?"!--"===l[1]?n=U:void 0!==l[1]?n=N:void 0!==l[2]?(L.test(l[2])&&(r=RegExp("</"+l[2],"g")),n=I):void 0!==l[3]&&(n=I):n===I?">"===l[0]?(n=r??M,c=-1):void 0===l[1]?c=-2:(c=n.lastIndex-l[2].length,s=l[1],n=void 0===l[3]?I:'"'===l[3]?H:z):n===H||n===z?n=I:n===U||n===N?n=M:(n=I,r=void 0);const h=n===I&&t[o+1].startsWith("/>")?" ":"";a+=n===M?e+C:c>=0?(i.push(s),e.slice(0,c)+S+e.slice(c)+k+h):e+k+(-2===c?o:h)}return[J(t,a+(t[s]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),i]})(t,e);if(this.el=F.createElement(l,s),Q.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(i=Q.nextNode())&&o.length<n;){if(1===i.nodeType){if(i.hasAttributes())for(const t of i.getAttributeNames())if(t.endsWith(S)){const e=c[a++],s=i.getAttribute(t).split(k),n=/([.?@])?(.*)/.exec(e);o.push({type:1,index:r,name:n[2],strings:s,ctor:"."===n[1]?G:"?"===n[1]?tt:"@"===n[1]?et:X}),i.removeAttribute(t)}else t.startsWith(k)&&(o.push({type:6,index:r}),i.removeAttribute(t));if(L.test(i.tagName)){const t=i.textContent.split(k),e=t.length-1;if(e>0){i.textContent=_?_.emptyScript:"";for(let s=0;s<e;s++)i.append(t[s],T()),Q.nextNode(),o.push({type:2,index:++r});i.append(t[e],T())}}}else if(8===i.nodeType)if(i.data===E)o.push({type:2,index:r});else{let t=-1;for(;-1!==(t=i.data.indexOf(k,t+1));)o.push({type:7,index:r}),t+=k.length-1}r++}}static createElement(t,e){const s=P.createElement("template");return s.innerHTML=t,s}}function K(t,e,s=t,i){if(e===j)return e;let r=void 0!==i?s._$Co?.[i]:s._$Cl;const a=O(e)?void 0:e._$litDirective$;return r?.constructor!==a&&(r?._$AO?.(!1),void 0===a?r=void 0:(r=new a(t),r._$AT(t,s,i)),void 0!==i?(s._$Co??=[])[i]=r:s._$Cl=r),void 0!==r&&(e=K(t,r._$AS(t,e.values),r,i)),e}class Y{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??P).importNode(e,!0);Q.currentNode=i;let r=Q.nextNode(),a=0,n=0,o=s[0];for(;void 0!==o;){if(a===o.index){let e;2===o.type?e=new Z(r,r.nextSibling,this,t):1===o.type?e=new o.ctor(r,o.name,o.strings,this,t):6===o.type&&(e=new st(r,this,t)),this._$AV.push(e),o=s[++n]}a!==o?.index&&(r=Q.nextNode(),a++)}return Q.currentNode=P,i}p(t){let e=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class Z{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=W,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=K(this,t,e),O(t)?t===W||null==t||""===t?(this._$AH!==W&&this._$AR(),this._$AH=W):t!==this._$AH&&t!==j&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>R(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==W&&O(this._$AH)?this._$AA.nextSibling.data=t:this.T(P.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:s}=t,i="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=F.createElement(J(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{const t=new Y(i,this),s=t.u(this.options);t.p(e),this.T(s),this._$AH=t}}_$AC(t){let e=B.get(t.strings);return void 0===e&&B.set(t.strings,e=new F(t)),e}k(t){R(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const r of t)i===e.length?e.push(s=new Z(this.O(T()),this.O(T()),this,this.options)):s=e[i],s._$AI(r),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class X{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,r){this.type=1,this._$AH=W,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=r,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=W}_$AI(t,e=this,s,i){const r=this.strings;let a=!1;if(void 0===r)t=K(this,t,e,0),a=!O(t)||t!==this._$AH&&t!==j,a&&(this._$AH=t);else{const i=t;let n,o;for(t=r[0],n=0;n<r.length-1;n++)o=K(this,i[s+n],e,n),o===j&&(o=this._$AH[n]),a||=!O(o)||o!==this._$AH[n],o===W?t=W:t!==W&&(t+=(o??"")+r[n+1]),this._$AH[n]=o}a&&!i&&this.j(t)}j(t){t===W?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class G extends X{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===W?void 0:t}}class tt extends X{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==W)}}class et extends X{constructor(t,e,s,i,r){super(t,e,s,i,r),this.type=5}_$AI(t,e=this){if((t=K(this,t,e,0)??W)===j)return;const s=this._$AH,i=t===W&&s!==W||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,r=t!==W&&(s===W||i);i&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class st{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){K(this,t)}}const it=w.litHtmlPolyfillSupport;it?.(F,Z),(w.litHtmlVersions??=[]).push("3.3.1");const rt=globalThis;
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
/**
   ...
   */function dt(t){return ct({...t,state:!0,attribute:!1})}var ht=Object.defineProperty,ut=(t,e,s,i)=>{for(var r,a=void 0,n=t.length-1;n>=0;n--)(r=t[n])&&(a=r(e,s,a)||a);return a&&ht(e,s,a),a};const pt=class extends at{constructor(){super(...arguments),this.contactsWarning=5,this.contactsCritical=10,this.waitWarning=120,this.waitCritical=300,this.dataRefreshInterval=3e4,this.uiRefreshInterval=1e3,this.demoMode=!1,this.queueStats=[],this.agentRoster=new Map,this.isPanelOpen=!1,this.panelPosition={top:0,left:0},this.isLoading=!0,this.hasError=!1,this.errorMessage="",this.handleOutsideClick=t=>{this.isPanelOpen&&!this.shadowRoot?.contains(t.target)&&(this.isPanelOpen=!1)}}connectedCallback(){super.connectedCallback(),this.initialize(),document.addEventListener("click",this.handleOutsideClick)}disconnectedCallback(){super.disconnectedCallback(),this.cleanup(),document.removeEventListener("click",this.handleOutsideClick)}async initialize(){try{this.isLoading=!0,this.hasError=!1,this.demoMode||(await this.fetchQueueStatistics(),this._dataRefreshTimer=setInterval(()=>this.fetchQueueStatistics(),this.dataRefreshInterval)),this._uiRefreshTimer=setInterval(()=>this.updateTemplate(),this.uiRefreshInterval)}catch(t){this.handleError(t)}}cleanup(){this._dataRefreshTimer&&clearInterval(this._dataRefreshTimer),this._uiRefreshTimer&&clearInterval(this._uiRefreshTimer)}async fetchQueueStatistics(){if(!this.token||!this.orgId)return this.hasError=!0,this.isLoading=!1,void(this.errorMessage="Missing token/orgId - check the widget attributes in the Desktop Layout configuration.");const t={Authorization:`Bearer ${this.token}`,"Content-Type":"application/json",Accept:"application/json"},e=Date.now(),s={query:`{\n        task(\n          from: ${e-864e5}\n          to: ${e}\n          filter: {\n            and: [\n              { isActive: { equals: true } }\n              { status: { equals: "parked" } }\n            ]\n          }\n          aggregations: [\n            { field: "id", type: count, name: "contacts" }\n            { field: "createdTime", type: min, name: "oldestStart" }\n          ]\n        ) {\n          tasks {\n            lastQueue { id name }\n            aggregation { name value }\n          }\n        }\n      }`};try{const e=await fetch("https://api.wxcc-us1.cisco.com/search",{method:"POST",headers:t,body:JSON.stringify(s),redirect:"follow"}),i=await e.json().catch(()=>null);if(!e.ok||i?.errors||i?.error)throw new Error(`Task search request failed (${e.status}): ${JSON.stringify(i?.errors||i?.error||i)}`);this.queueData=i?.data?.task?.tasks??[],this.updateTemplate(),this.isLoading=!1,this.hasError=!1,this.getAgentRoster()}catch(i){this.handleError(i)}}async getAgentRoster(){if(this.demoMode||!this.queueStats.length)return;const t={Authorization:`Bearer ${this.token}`,"Content-Type":"application/json",Accept:"application/json"},e=await Promise.all(this.queueStats.map(async e=>{if(!e.id)return{queueId:e.id,roster:null};try{const s=await fetch(`https://api.wxcc-us1.cisco.com/organization/${this.orgId}/v1/agents/buddy-agents-list`,{method:"POST",headers:t,body:JSON.stringify({queueId:e.id}),redirect:"follow",signal:AbortSignal.timeout(5e3)});if(202===s.status)return console.info(`Agent roster for "${e.name}" is delivered asynchronously; live status unavailable.`),{queueId:e.id,roster:null};if(!s.ok)return{queueId:e.id,roster:null};const i=await s.json(),r=this.parseAgentRoster(i);return{queueId:e.id,roster:r}}catch(s){return console.error(`Error fetching agent roster for queue ${e.id}:`,s),{queueId:e.id,roster:null}}})),s=new Map(this.agentRoster);for(const{queueId:i,roster:r}of e)s.set(i,r);this.agentRoster=s}parseAgentRoster(t){const e=t?.data??t?.agents??t?.agentList??(Array.isArray(t)?t:null);return Array.isArray(e)?e.map(t=>{const e=t.state??t.agentState??t.status??"";return{id:t.id??t.agentId??"",name:t.name??t.agentName??t.displayName??"Unknown Agent",state:this.normalizeAgentState(e),stateDurationSeconds:t.stateDuration??t.stateDurationSeconds??void 0}}):null}normalizeAgentState(t){const e=(t||"").toLowerCase();return e.includes("available")?"available":e.includes("wrap")?"wrapup":e.includes("call")||e.includes("engaged")||e.includes("connect")||e.includes("talk")?"oncall":"unknown"}updateTemplate(){this.queueData&&Array.isArray(this.queueData)?(this.queueStats=this.queueData.map(t=>{const e=t.aggregation?.find(t=>"contacts"===t.name)?.value||0,s=t.aggregation?.find(t=>"oldestStart"===t.name)?.value||0,i=s?Math.floor((Date.now()-s)/1e3):0;return{id:t.lastQueue?.id||"",name:t.lastQueue?.name||"Unknown Queue",contacts:e,waitTimeSeconds:i,status:this.calculateStatus(e,i)}}),this.queueStats.sort((t,e)=>{const s={critical:3,warning:2,ok:1};return(s[e.status]||0)-(s[t.status]||0)})):this.queueStats=[]}calculateStatus(t,e){return t>=this.contactsCritical||e>=this.waitCritical?"critical":t>=this.contactsWarning||e>=this.waitWarning?"warning":"ok"}formatWaitTime(t){const e=t%60;return`${Math.floor(t/60).toString().padStart(2,"0")}:${e.toString().padStart(2,"0")}`}getStatusText(t){switch(t){case"critical":return"Critical";case"warning":return"Warning";default:return"OK"}}getStatusPillLabel(t){switch(t){case"available":return"Ready";case"oncall":return"In Call";case"wrapup":return"Wrap Up";default:return"Unknown"}}togglePanel(t){if(this.isPanelOpen)return void(this.isPanelOpen=!1);const e=t.currentTarget.getBoundingClientRect();this.panelPosition={top:e.bottom+6,left:Math.max(8,Math.min(e.left,window.innerWidth-380))},this.isPanelOpen=!0}closePanel(){this.isPanelOpen=!1}handleError(t){console.error("Queue Statistics Error:",t),this.hasError=!0,this.isLoading=!1,this.errorMessage=t.message||"Failed to load queue statistics"}render(){return D`
    ...
    `:D`
      ...
      `}renderQueueCard(t,e){const s=this.agentRoster.get(t.id),i=s?s.filter(t=>"available"===t.state).length:null,r=s?s.filter(t=>"oncall"===t.state).length:null,a=0===t.contacts,n=!a;return D`
    ...
    `):D`<div class="roster-empty">No agents currently assigned</div>`}};pt.styles=((t,...e)=>{const s=1===t.length?t[0]:e.reduce((e,s,i)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[i+1],t[0]);return new a(s,t,i)})`
