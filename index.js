              ...
              ${a?Q`
                <div class="sparkline-container">
                  <svg class="sparkline" viewBox="0 0 50 20" preserveAspectRatio="none">
                    <path class="sparkline-area ${t.status}" d="${i.areaPath}"></path>
                    <path class="sparkline-line ${t.status}" d="${i.linePath}"></path>
                    ${s?Q`
                      <circle class="sparkline-dot ${t.status}" cx="${s.x}" cy="${s.y}" r="2"></circle>
                    `:""}
                  </svg>
                  <span class="trend-indicator ${n}">${this.getTrendIcon(n)}</span>
                </div>
              `:""}
